 ...
 */
final class Version20181123164616 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__book AS SELECT id, owner_id, title, description, cover, isbn, authors, slug FROM book');
        ...
        , slug VARCHAR(128) NOT NULL COLLATE BINARY, comments CLOB DEFAULT NULL, location VARCHAR(40) DEFAULT NULL, CONSTRAINT FK_CBE5A3317E3C61F9 FOREIGN KEY (owner_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO book (id, owner_id, title, description, cover, isbn, authors, slug) SELECT id, owner_id, title, description, cover, isbn, authors, slug FROM __temp__book');
